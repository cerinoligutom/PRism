...
- Reviews and Comments tabs in the PR detail view now use a bordered + filled card chrome similar to the Threads tab, with an accent-colour border on hover so each review or comment reads as a self-contained card (#413).
